    ...
    */
    ...
    public void drawImage(String name, int x, int y, int width, int height,
        ...
        if (fh.canRead()) {
            ...
            java.awt.Image img = Toolkit.getDefaultToolkit().getImage(name);
    ...
    /* from Image, unscaled*/
    public void drawImage(java.awt.Image img, int x, int y, boolean redraw) {
        imgGraphic.drawImage(img, x, y, this.getBackground(), this);
        if (redraw)
            display();
    }
